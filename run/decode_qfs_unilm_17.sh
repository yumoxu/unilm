...
export INPUT_FILE_NAME=rr-39_config-26000_iter-query-ir-dial-tf-2007-top150-prepend_len-prepend_masked_q
...
export CKPT=1000,1500,2000,2500,3000,3500,4000,4500,5000
