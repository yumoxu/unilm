...
export MODEL_PATH=$PROJ_PATH/model/unilm_13
export SPLIT=val
...
# finished: 27000,28500
# nuess: 16500,18000,19500,21000,22500,24000,25500,27000,28500
# duflo: 30000,31500,33000,34500,36000,37500,39000
export CKPT=30000,31500,33000,34500,36000,37500,39000
